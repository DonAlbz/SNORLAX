...
<section class="home">
    ...
    <div class="blocco blocco-1">
        <div class="blocco-testo">
            ...
            <a href="<?= e(url_with_lang('dashboard.php')) ?>" class="btn-blocco"><?= e(t('user_dashboard')) ?> <i class="bi bi-arrow-right"></i></a>
        </div>
...
<section class="filosofia">
    <div class="filosofia-header">
        <div class="etichetta etichetta-centered"><span class="etichetta-linea"></span><?= e(t('philosophy_tag')) ?><span class="etichetta-linea"></span></div>
    ...
    <div class="filosofia-stats">
        ...
        <div class="fstat"><span class="fstat-num">+12k</span><span class="fstat-label"><?= e(t('nights_analyzed')) ?></span></div>
        <div class="fstat-divider"></div>
        <div class="fstat"><span class="fstat-num">3</span><span class="fstat-label"><?= e(t('models_available')) ?></span></div>
        <div class="fstat-divider"></div>
        <div class="fstat"><span class="fstat-num">24<em>/7</em></span><span class="fstat-label"><?= e(t('active_support')) ?></span></div>
    </div>
</section>
<section class="dashboard-preview">
    <div class="dashboard-preview-inner">
        <div class="dashboard-testo">
            ...
            <a href="<?= e(url_with_lang('dashboard.php')) ?>" class="btn-dashboard"><?= e(t('go_dashboard')) ?> <i class="bi bi-arrow-right"></i></a>
        </div>
...
<section class="section-invito">
    <div class="contenuto-invito">
        ...
        <div class="section-buttons"><a href="<?= e(url_with_lang('login.php')) ?>" class="btn-principale"><span><?= e(t('buy_now')) ?></span></a><a href="<?= e(url_with_lang('contatti.php')) ?>" class="btn-secondario"><?= e(t('talk_to_us')) ?></a></div>
    </div>
</section>
